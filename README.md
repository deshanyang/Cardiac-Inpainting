...
Additionally, application of this model relies on FFDNet for denoising and adding noise back into the inpainted region. The code for FFDNet can be found at https://github.com/cszn/FFDNet.
